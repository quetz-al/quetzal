...
try:
    import quetzal.app
    version = '.'.join(quetzal.app.__version__.split('.')[:2])
    release = quetzal.app.__version__
    del quetzal.app
except:
...
latex_documents = [
    (master_doc, 'Quetzal.tex', 'Quetzal Documentation',
     'David Ojeda', 'manual'),
]
...
man_pages = [
    (master_doc, 'quetzal', 'Quetzal Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Quetzal', 'Quetzal Documentation',
     author, 'Quetzal', 'One line description of project.',
     'Miscellaneous'),
]
